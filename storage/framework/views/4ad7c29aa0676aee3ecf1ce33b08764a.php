        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="<?php echo e(route('dodaj.add')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <center>
...
<?php endif; ?><?php /**PATH C:\Users\manie\Desktop\rekrutacja laravel\zadanie\resources\views/dodaj.blade.php ENDPATH**/ ?>